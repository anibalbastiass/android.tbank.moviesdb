package com.anibalbastias.coolmovies.library.base.ui.component.view
...
import com.anibalbastias.coolmovies.library.base.ui.extension.dpToPx
...
class DotLoadingIndicatorView : View {
    ...
    private var cornerRadius: Float = dpToPx(
        BACKGROUND_SQUARE_CORNER_RADIUS
    ).toFloat()
    private var squareWidth: Int =
        dpToPx(
            BACKGROUND_SQUARE_WIDTH
        )
    ...
    private fun init() {
        ...
        backgroundBorderPaint!!.strokeWidth = dpToPx(
            1
        ).toFloat(
